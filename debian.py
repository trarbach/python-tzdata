...
update = "cd /tmp;wget https://data.iana.org/time-zones/releases/tzdata2018f.tar.gz --no-check-certificate; tar -xvzf tzdata2018f.tar.gz; zic -d zoneinfo southamerica;cp zoneinfo/America/Sao_Paulo /usr/share/zoneinfo/America/Sao_Paulo;dpkg-reconfigure tzdata "
